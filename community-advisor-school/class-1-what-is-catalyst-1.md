...
After the proposers are finished with their review, the vCAs come to play and review the assessments as well, prioritizing those flagged by the proposers in the previous phase. The vCAs also use the [Red and Yellow Card Thing](https://docs.google.com/document/u/0/d/1LTw7iY-\_XJ5welSUk-olRvkfyVuOIPcR\_iAgqbnZv8c/edit) to review the assessments, and, based on the rules stated in the mentioned document, each assessment is evaluated and then be considered in the final score of the proposal, or disregarded if it’s a low quality assessment for some reason.
